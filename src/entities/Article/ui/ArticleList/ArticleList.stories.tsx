...
export const IsLoadingWide = Template.bind({});
IsLoadingWide.args = {
  isLoading: true,
  articles: [],
  view: ArticleView.WIDE,
};
export const IsLoadingSquare = Template.bind({});
IsLoadingSquare.args = {
  isLoading: true,
  articles: [],
  view: ArticleView.SQUARE,
};
export const ListSquare = Template.bind({});
ListSquare.args = {
  isLoading: false,
...
export const ListWide = Template.bind({});
ListWide.args = {
  isLoading: false,
